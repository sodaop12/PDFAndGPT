  ...
  methods: {
    addProduct() {
      ...
      const ProductEng = {
       ...
       axios.post('http://127.0.0.1:5000/GPT_Desproduct', ProductEng)
        .then(response => {
    ...
    addProductThai() {
      ...
      const ProductThai = {
       ...
       axios.post('http://127.0.0.1:5000/GPT_Desproduct', ProductThai)
        .then(response => {
          console.log(response.data.message); 
          this.thairesponse.Thainame = response.data.name;
          this.thairesponse.ThaiGPT = response.data.GPT;
